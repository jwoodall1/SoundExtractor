...
/**
 * Very small CSV parser: supports quoted values and commas/newlines inside quotes.
 * Returns an array of rows (each row is string[]).
 */
...
async function loadManifest() {
  ...
  availableFileList = json.files.slice().sort((a, b) => a.localeCompare(b, undefined, { numeric: true }));
...
els.filter.addEventListener("input", () => renderFilesList(normalizeBasePath(els.basePath.value), els.filter.value));
